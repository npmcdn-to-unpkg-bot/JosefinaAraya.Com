...
<style type="text/css">
    body {
        <?php global $bd_data;
        if ($bd_data['background_displays'] == 'bg_cutsom') :; ?>
    ...
    <?php if (!empty($bg['attachment'])) { ?>background-attachment:<?php echo $bg['attachment'] ?> ; <?php echo "\n";
        ...
        <?php elseif ($bd_data['background_displays'] == 'bg_pattren') : ?>
            <?php if (array_key_exists('pattrens_bg', $bd_data)) {
                if ($bd_data['pattrens_bg'] == 'none') { ?><?php echo "\n";
        }
    } ?>
            <?php if (array_key_exists('pattrens_bg', $bd_data)) {
                if ($bd_data['pattrens_bg'] == 'pat1') { ?><?php if (!empty($bd_data['custom_pattrens_color'])) { ?>background-color:<?php echo $bd_data['custom_pattrens_color'] ?>; <?php } ?> background-image: url("<?php echo get_template_directory_uri() ?>/images/pattrens/pat-1.png"); background-position: center center; background-repeat: repeat; <?php echo "\n";
        }
    } ?>
            <?php if (array_key_exists('pattrens_bg', $bd_data)) {
                if ($bd_data['pattrens_bg'] == 'pat2') { ?><?php if (!empty($bd_data['custom_pattrens_color'])) { ?>background-color:<?php echo $bd_data['custom_pattrens_color'] ?>; <?php } ?> background-image: url("<?php echo get_template_directory_uri() ?>/images/pattrens/pat-2.png"); background-position: center center; background-repeat: repeat; <?php echo "\n";
        }
    } ?>
            <?php if (array_key_exists('pattrens_bg', $bd_data)) {
                if ($bd_data['pattrens_bg'] == 'pat3') { ?><?php if (!empty($bd_data['custom_pattrens_color'])) { ?>background-color:<?php echo $bd_data['custom_pattrens_color'] ?>; <?php } ?> background-image: url("<?php echo get_template_directory_uri() ?>/images/pattrens/pat-3.png"); background-position: center center; background-repeat: repeat; <?php echo "\n";
        }
    } ?>
        <?php if (array_key_exists('pattrens_bg', $bd_data)) {
            if ($bd_data['pattrens_bg'] == 'pat4') { ?><?php if (!empty($bd_data['custom_pattrens_color'])) { ?>background-color:<?php echo $bd_data['custom_pattrens_color'] ?>; <?php } ?> background-image: url("<?php echo get_template_directory_uri() ?>/images/pattrens/pat-4.png"); background-position: center center; background-repeat: repeat; <?php echo "\n";
        }
    } ?>
            <?php if (array_key_exists('pattrens_bg', $bd_data)) {
                if ($bd_data['pattrens_bg'] == 'pat5') { ?><?php if (!empty($bd_data['custom_pattrens_color'])) { ?>background-color:<?php echo $bd_data['custom_pattrens_color'] ?>; <?php } ?> background-image: url("<?php echo get_template_directory_uri() ?>/images/pattrens/pat-5.png"); background-position: center center; background-repeat: repeat; <?php echo "\n";
                }
            } ?>
            <?php if (array_key_exists('pattrens_bg', $bd_data)) {
                if ($bd_data['pattrens_bg'] == 'pat6') { ?><?php if (!empty($bd_data['custom_pattrens_color'])) { ?>background-color:<?php echo $bd_data['custom_pattrens_color'] ?>; <?php } ?> background-image: url("<?php echo get_template_directory_uri() ?>/images/pattrens/pat-6.png"); background-position: center center; background-repeat: repeat; <?php echo "\n";
        }
    } ?>
        <?php if (array_key_exists('pattrens_bg', $bd_data)) {
            if ($bd_data['pattrens_bg'] == 'pat7') { ?><?php if (!empty($bd_data['custom_pattrens_color'])) { ?>background-color:<?php echo $bd_data['custom_pattrens_color'] ?>; <?php } ?> background-image: url("<?php echo get_template_directory_uri() ?>/images/pattrens/pat-7.png"); background-position: center center; background-repeat: repeat; <?php echo "\n";
            }
        } ?>
        <?php if (array_key_exists('pattrens_bg', $bd_data)) {
            if ($bd_data['pattrens_bg'] == 'pat8') { ?><?php if (!empty($bd_data['custom_pattrens_color'])) { ?>background-color:<?php echo $bd_data['custom_pattrens_color'] ?>; <?php } ?> background-image: url("<?php echo get_template_directory_uri() ?>/images/pattrens/pat-8.png"); background-position: center center; background-repeat: repeat; <?php echo "\n";
        }
    } ?>
        <?php if (array_key_exists('pattrens_bg', $bd_data)) {
            if ($bd_data['pattrens_bg'] == 'pat9') { ?><?php if (!empty($bd_data['custom_pattrens_color'])) { ?>background-color:<?php echo $bd_data['custom_pattrens_color'] ?>; <?php } ?> background-image: url("<?php echo get_template_directory_uri() ?>/images/pattrens/pat-9.png"); background-position: center center; background-repeat: repeat; <?php echo "\n";
            }
        } ?>
        <?php if (array_key_exists('pattrens_bg', $bd_data)) {
            if ($bd_data['pattrens_bg'] == 'pat10') { ?><?php if (!empty($bd_data['custom_pattrens_color'])) { ?>background-color:<?php echo $bd_data['custom_pattrens_color'] ?>; <?php } ?> background-image: url("<?php echo get_template_directory_uri() ?>/images/pattrens/pat-10.png"); background-position: center center; background-repeat: repeat; <?php echo "\n";
        }
    } ?>
        <?php if (array_key_exists('pattrens_bg', $bd_data)) {
            if ($bd_data['pattrens_bg'] == 'pat11') { ?><?php if (!empty($bd_data['custom_pattrens_color'])) { ?>background-color:<?php echo $bd_data['custom_pattrens_color'] ?>; <?php } ?> background-image: url("<?php echo get_template_directory_uri() ?>/images/pattrens/pat-11.png"); background-position: center center; background-repeat: repeat; <?php echo "\n";
        }
    } ?>
        <?php if (array_key_exists('pattrens_bg', $bd_data)) {
            if ($bd_data['pattrens_bg'] == 'pat12') { ?><?php if (!empty($bd_data['custom_pattrens_color'])) { ?>background-color:<?php echo $bd_data['custom_pattrens_color'] ?>; <?php } ?> background-image: url("<?php echo get_template_directory_uri() ?>/images/pattrens/pat-12.png"); background-position: center center; background-repeat: repeat; <?php echo "\n";
        }
    } ?>
        <?php if (array_key_exists('pattrens_bg', $bd_data)) {
            if ($bd_data['pattrens_bg'] == 'pat13') { ?><?php if (!empty($bd_data['custom_pattrens_color'])) { ?>background-color:<?php echo $bd_data['custom_pattrens_color'] ?>; <?php } ?> background-image: url("<?php echo get_template_directory_uri() ?>/images/pattrens/pat-13.png"); background-position: center center; background-repeat: repeat; <?php echo "\n";
        }
    } ?>
        <?php if (array_key_exists('pattrens_bg', $bd_data)) {
            if ($bd_data['pattrens_bg'] == 'pat14') { ?><?php if (!empty($bd_data['custom_pattrens_color'])) { ?>background-color:<?php echo $bd_data['custom_pattrens_color'] ?>; <?php } ?> background-image: url("<?php echo get_template_directory_uri() ?>/images/pattrens/pat-14.png"); background-position: center center; background-repeat: repeat; <?php echo "\n";
        }
    } ?>
    <?php if (array_key_exists('pattrens_bg', $bd_data)) {
        if ($bd_data['pattrens_bg'] == 'pat15') { ?><?php if (!empty($bd_data['custom_pattrens_color'])) { ?>background-color:<?php echo $bd_data['custom_pattrens_color'] ?>; <?php } ?> background-image: url("<?php echo get_template_directory_uri() ?>/images/pattrens/pat-15.png"); background-position: center center; background-repeat: repeat; <?php echo "\n";
        }
    } ?>
            <?php if (array_key_exists('pattrens_bg', $bd_data)) {
                if ($bd_data['pattrens_bg'] == 'pat16') { ?><?php if (!empty($bd_data['custom_pattrens_color'])) { ?>background-color:<?php echo $bd_data['custom_pattrens_color'] ?>; <?php } ?> background-image: url("<?php echo get_template_directory_uri() ?>/images/pattrens/pat-16.png"); background-position: center center; background-repeat: repeat; <?php echo "\n";
        }
    } ?>
        <?php if (array_key_exists('pattrens_bg', $bd_data)) {
            if ($bd_data['pattrens_bg'] == 'pat17') { ?><?php if (!empty($bd_data['custom_pattrens_color'])) { ?>background-color:<?php echo $bd_data['custom_pattrens_color'] ?>; <?php } ?> background-image: url("<?php echo get_template_directory_uri() ?>/images/pattrens/pat-17.png"); background-position: center center; background-repeat: repeat; <?php echo "\n";
        }
    } ?>
        <?php if (array_key_exists('pattrens_bg', $bd_data)) {
            if ($bd_data['pattrens_bg'] == 'pat18') { ?><?php if (!empty($bd_data['custom_pattrens_color'])) { ?>background-color:<?php echo $bd_data['custom_pattrens_color'] ?>; <?php } ?> background-image: url("<?php echo get_template_directory_uri() ?>/images/pattrens/pat-18.png"); background-position: center center; background-repeat: repeat; <?php echo "\n";
        }
    } ?>
        <?php if (array_key_exists('pattrens_bg', $bd_data)) {
            if ($bd_data['pattrens_bg'] == 'pat19') { ?><?php if (!empty($bd_data['custom_pattrens_color'])) { ?>background-color:<?php echo $bd_data['custom_pattrens_color'] ?>; <?php } ?> background-image: url("<?php echo get_template_directory_uri() ?>/images/pattrens/pat-19.png"); background-position: center center; background-repeat: repeat; <?php echo "\n";
            }
        } ?>
            <?php if (array_key_exists('pattrens_bg', $bd_data)) {
                if ($bd_data['pattrens_bg'] == 'pat20') { ?>background-image: url("<?php echo get_template_directory_uri() ?>/images/pattrens/pat-20.png"); background-position: center center; background-repeat: repeat; <?php echo "\n";
        }
    } ?>
    <?php endif; ?>
    }
    <?php if (array_key_exists('custom_css', $bd_data)) {
        $css_var = $bd_data['custom_css'];
    } else {
        $css_var = '';
    } $css_code = str_replace("<pre>", "", stripslashes($css_var));
