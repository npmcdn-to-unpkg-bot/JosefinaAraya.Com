...
function theme_colors($input,$head = true)
{
    ...
    <ul class="box_layout_list bd_box_layout">
        ...
        <li <?php if($bd_option['bd_setting']['theme_colors'] == 'color1'){ echo 'class="selectd"'; } ?>>
            <span class="theme_colors_spans color-1 ttip" title="Default"> D </span>
...
function bgop($input,$head = true)
{
    ...
    <select class="tybo-weight" name="<?php echo $input['id']; ?>[repeat]" id="<?php echo $input['id']; ?>[repeat]">
    ...
    <select class="tybo-weight" name="<?php echo $input['id']; ?>[attachment]" id="<?php echo $input['id']; ?>[attachment]">
    ...
    <select class="tybo-weight" name="<?php echo $input['id']; ?>[hor]" id="<?php echo $input['id']; ?>[hor]">
    ...
    <select class="tybo-weight" name="<?php echo $input['id']; ?>[ver]" id="<?php echo $input['id']; ?>[ver]" >
...
function radio_input($input,$head = true)
{
    ...
    ?>
        ...
        <label class="check_radio">
            <input class="r_<?php echo $input['id'];?> <?php $class_name = (isset($input['class'])) ? $input['class'] : ""; echo $class_name; ?>" name="<?php echo $input['id']; ?>" id="<?php echo $input['id']; ?>" type="radio" value="<?php echo $key ?>" <?php if($bd_option['bd_setting'][$input['id']] == $key){echo 'checked="checked"';}?>>
