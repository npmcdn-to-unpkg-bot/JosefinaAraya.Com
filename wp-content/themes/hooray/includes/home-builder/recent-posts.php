...
<div class="recent-box <?php echo $display ?>">
    ...
    <?php else: ?>
            <article class="blog-two half-width-category <?php if( $bd_count == 2 ) { echo 'last-column'; $bd_count= 0; } ?>" id="post-<?php the_ID(); ?>">
                ...
                <div class="post-readmore"><a href="<?php the_permalink() ?>" rel="bookmark" title="<?php _e('Permanent Link to', 'bd'); ?> <?php the_title_attribute(); ?>"  class="btn btn-small"><?php _e('Leer Mas', 'bd'); ?></a></div><!-- .post-readmore/-->
            </article>
    <?php endif; ?>
